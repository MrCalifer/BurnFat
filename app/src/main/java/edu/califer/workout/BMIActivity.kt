...
class BMIActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        btnCalculateUnits.setOnClickListener {
            ...
            if (currentVisibleView == METRIC_UNITS_VIEW)
            {
                ...
                {
                    if (!tilMetricUnitHeight.isErrorEnabled && !tilMetricUnitWeight.isErrorEnabled)
                    {
                ...
                {
                    etMetricUnitHeight.error = "Fill the required fields"
                    etMetricUnitWeight.error = "Fill the required fields"
                }
            }
            else
            {
                ...
                if (validateUsUnits())
                {
                    if (!tilUsUnitWeight.isErrorEnabled && !tilUsUnitHeightFeet.isErrorEnabled && !tilUsUnitHeightInch.isErrorEnabled)
                    {
                ...
                {
                    etUsUnitHeightFeet.error = "Fill the required fields"
                    etUsUnitHeightInch.error = "Fill the required fields"
                    etUsUnitWeight.error = "Fill the required fields"
                }
            }
        }
    ...
    private fun makeVisibleMetricUnitsView()
    {
        ...
        tilMetricUnitHeight.isErrorEnabled = false
        tilMetricUnitWeight.isErrorEnabled = false
    }
    ...
    private fun makeVisibleUsUnitsView()
    {
        ...
        tilUsUnitWeight.isErrorEnabled = false
        tilUsUnitHeightFeet.isErrorEnabled  = false
        tilUsUnitHeightInch.isErrorEnabled = false
    }
